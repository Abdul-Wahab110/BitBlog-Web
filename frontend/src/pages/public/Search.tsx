...
export const Search: React.FC = () => {
  ...
  const [pagination, setPagination] = useState({ page: pageParam, limit: postsPerPage, total: 0, totalPages: 1 });
  ...
  }, [query, categoryParam, tagParam, authorParam, sortParam, pageParam, postsPerPage]);
