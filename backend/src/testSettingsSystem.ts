...
async function testSettings() {
  ...
  try {
    ...
    // 2. Update settings
    const testPayload = {
      site_name: 'BitBlog Digital Journal 2026',
      contact_email: 'chief-editor@bitblog.com',
    ...
    assert(updated.site_name === 'BitBlog Digital Journal 2026', 'Updated site_name persisted');
    assert(updated.contact_email === 'chief-editor@bitblog.com', 'Updated contact_email persisted');
    ...
    assert(reFetched.site_name === 'BitBlog Digital Journal 2026', 'Refetched settings match real-time database state');
    assert(reFetched.contact_email === 'chief-editor@bitblog.com', 'Refetched contact_email matches');
